...
# if source == 'gitee':
#     os.system('wget -P {} {} '.format(hub_dir, url))
# else:
#     pass

# def _wget_gitee_zip(url, dirname):
#     r = os.system('wget -P {} {}'.format(dirname, url))
#     if not r:
#         raise RuntimeError('Command wrong, wget -P {} {}'.format(dirname, url)) 
...
# @unittest.skipIf(sys.platform != 'linux', 'linux have wget')
